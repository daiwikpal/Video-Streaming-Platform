...
export default function CoursePage() {
  ...
  const videoDetails = [
    { title: 'Introduction to AI', thumbnail: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROWtrw_24b76Of1QzStt6bG8xapakrJhiUizQWBmme7g&s', description: 'Video 1 Description' },
    { title: 'History of AI', thumbnail: '/assets/images/video2-placeholder.jpg', description: 'Video 2 Description' },
    { title: 'AI 1', thumbnail: '/assets/images/video2-placeholder.jpg', description: 'Video 2 Description' },
