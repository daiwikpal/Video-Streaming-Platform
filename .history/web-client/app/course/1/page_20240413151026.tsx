...
export default function CoursePage() {
  ...
  const videoDetails = [
    ...
    { title: 'Graph search algorithms', thumbnail: 'https://dist.neo4j.com/wp-content/uploads/20181010052900/breadth-first-search-graph-algorithm-example.png', description: 'Video 2 Description' },
