...
export default function CoursePage() {
  ...
  const videoDetails = [
    ...
    { title: 'Reinforcement learning', thumbnail: '/assets/images/video2-placeholder.jpg', description: 'Video 4 Description' },
    { title: 'AI 3', thumbnail: '/assets/images/video2-placeholder.jpg', description: 'Video 5 Description' },
